...
echo ""
echo "PHASE 5: DEVICES"
run_test "test/features/devices/domain/devices_domain_test.dart" "Devices Domain"
run_test "test/features/devices/data/devices_data_test.dart" "Devices Data"
run_test "test/features/devices/presentation/providers/devices_provider_test.dart" "Devices Provider"
run_test "test/features/devices/presentation/widgets/devices_widgets_test.dart" "Devices Widgets"
...
if flutter devices | grep -q "No devices"; then
  ...
  run_test "integration_test/features/devices/devices_integration_test.dart" "Devices Integration"
